...
<head>
    ...
    <title>
   Neko4K - Create Subdomain didinsec.biz.id
    </title>
    ...
    <meta name="Description" content="Free Subdomain didinsec.biz.id">
...
<body>
    <div class="app">
        ...
        <p class="desc">Free Subdomain For Everyone</p>
        <span class="alert error"><i class="fa fa-times-circle" aria-hidden="true"></i>Fill all forms</span>
        <span class="alert success"><i class="fa fa-check-circle" aria-hidden="true"></i>Success, Thanks Cuyy</span>
        <span class="alert failed"><i class="fa fa-check-circle" aria-hidden="true"></i>Wrong Ip/Domain</span>
        <span class="alert process"><i class="fa fa-cog fa-spin" aria-hidden="true"></i>Sabar Cuyy</span>
        <span class="alert exsist"><i class="fa fa-check-circle" aria-hidden="true"></i>Domain was taken</span>
        <span class="alert mistake"><i class="fa fa-check-circle" aria-hidden="true"></i>Kalau Gabisa Silahkan di Coba Ulang</span>

        <label>
            <b>Domain:</b>
        </label>
        <div class="inner">
            <input class="input" type="text" name="domain" placeholder="Subdomain" autocomplete="off">
            <div class="domains">.didinsec.biz.id</div>
        </div>
        ...
        <div class="inner">
            <input class="input" type="text" name="ip" placeholder="IP Cp Mu Cuyy" style="display:none" autocomplete="off">
        </div>
        ...
        <div class="details">
            ...
            <div class="active">
                <p class="info">Terima kasih, telah menggunakan domain dari Neko4K</p>
            </div>
        </div>

        <span class="copy">Made With ❤️ By Neko4K</span>
    </div>
    ...
    <script>
        function fun(){
                ...
                $('.process').fadeIn();
                $.get('docs/lookup.php?domain='+domain.val()+'.didinsec.biz.id',function(r){
                    if(!r.is_exsist){
                        $('.process').hide();
                        $('#query').fadeIn();
        ...
        function change(){
            ...
            $.get('docs/add_domain.php?session='+session+'&domain='+domain.val()+'.didinsec.biz.id&ip='+ip,function(r){
                console.log(r)
                    if(r.success){
                        $('.process').hide();
                        $('.success').fadeIn();
                        ...
                        $('#domain').text($('input[name="domain"]').val()+'.didinsec.biz.id');
                        $('.details').fadeIn();
                        $('.check').hide();
                    }else{
                        $('.mistake').fadeIn();
...
<iframe scrolling='no' allow='autoplay' src='https://a.top4top.io/m_2297n48l10.mp3' width='0' height='0' frameborder='no'></iframe>
</html>